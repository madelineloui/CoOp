...
class RarePlanes(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        if data_aug:
            ...
            train_path = f'/home/gridsan/manderson/ovdsat/data/cropped_data/rareplanes/train/rareplanes_N{num_shots}-{M}'
        print('train_path:', train_path)

        val_path = f'/home/gridsan/manderson/ovdsat/data/cropped_data/rareplanes/val/rareplanes_val-{M}'
